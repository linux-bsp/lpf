...
static bool pconfig_static_available(void)
{
...
static int32_t pconfig_static_load(void)
{
	return pconfig_static_available() ? OSAL_SUCCESS : OSAL_ERR_GENERIC;
}

static void pconfig_static_unload(void)
{
}

static const pconfig_platform_config_t *pconfig_static_active(void)
{
	if (!pconfig_static_available())
		return NULL;
...
pconfig_static_find(const char *product, const char *project,
		    const char *version)
{
	uint32_t i;
...
static int32_t pconfig_static_list(const pconfig_platform_config_t **configs,
				   uint32_t *count)
{
...
const pconfig_backend_ops_t g_pconfig_static_backend = {
	.name = "static",
	.available = pconfig_static_available,
	.load = pconfig_static_load,
	.unload = pconfig_static_unload,
	.active = pconfig_static_active,
	.find = pconfig_static_find,
	.list = pconfig_static_list,
};
