 ...
 *
 * Provides structures and enums for test categorization, tagging, and
 * filtering. Supports runtime filtering by category, tags, timeout, and other
 * attributes.
 */
 ...
 * Usage: TEST_METADATA(TEST_CATEGORY_UNIT, TEST_TAG_FAST, 100, "Quick unit
 * test")
 */
 ...
 */
static inline bool test_metadata_matches_filter(const test_metadata_t *metadata,
