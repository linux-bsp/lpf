...
| CCM | `PRL_DEV_TYPE_CCM` | `prl_ccm.h` | 通信管理板 | 是 是 |
...
- **v1.2** (2026-06-01): 架构重构
  - 从"点对点"协议改为"按设备类型"组织
  - 删除旧的点对点协议文件（prl_gsc_pmc, prl_pmc_ccm, prl_ccm_satellite, prl_ccm_power）
  - 新增按设备类型组织的协议定义（prl_gsc, prl_pmc, prl_ccm, prl_power）
