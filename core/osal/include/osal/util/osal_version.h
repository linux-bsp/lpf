 ...
 */
#define OSAL_VERSION        OSAL_GetVersion()

/**
 * @brief 当前软件完整版本（版本号+Git）
 */
#define OSAL_VERSION_FULL   OSAL_GetVersionFull()

/**
 * @brief 当前Git commit
 */
#define OSAL_GIT_COMMIT     OSAL_GetGitCommit()

/**
 * @brief 构建时间戳
 */
#define OSAL_BUILD_TIME     OSAL_GetBuildTime()
