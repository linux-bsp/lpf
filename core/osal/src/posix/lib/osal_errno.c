...
const char *OSAL_get_status_name(int32_t status_code)
{
	...
	case OSAL_ERR_GENERIC:
		return "OSAL_ERR_GENERIC"; /* EIO=5 */
	case OSAL_ERR_INVALID_POINTER:
		return "OSAL_ERR_INVALID_POINTER"; /* EFAULT=14 */
	case OSAL_ERR_NO_MEMORY:
		return "OSAL_ERR_NO_MEMORY"; /* ENOMEM=12 */
	case OSAL_ERR_INVALID_SIZE:
		return "OSAL_ERR_INVALID_SIZE"; /* EINVAL=22 */
	case OSAL_ERR_NAME_TOO_LONG:
		return "OSAL_ERR_NAME_TOO_LONG"; /* ENAMETOOLONG=63 */
	case OSAL_ERR_NAME_TAKEN:
		return "OSAL_ERR_NAME_TAKEN"; /* EEXIST=17 */
	case OSAL_ERR_NAME_NOT_FOUND:
		return "OSAL_ERR_NAME_NOT_FOUND"; /* ENOENT=2 */
	case OSAL_ERR_TIMEOUT:
		return "OSAL_ERR_TIMEOUT"; /* ETIMEDOUT=60/110 */
	case OSAL_ERR_NOT_IMPLEMENTED:
		return "OSAL_ERR_NOT_IMPLEMENTED"; /* ENOSYS=78 */
	case OSAL_ERR_BUSY:
		return "OSAL_ERR_BUSY"; /* EBUSY=16 */
	case OSAL_ERR_PERMISSION:
		return "OSAL_ERR_PERMISSION"; /* EPERM=1 */
	case OSAL_ERR_NOT_SUPPORTED:
		return "OSAL_ERR_NOT_SUPPORTED"; /* ENOTSUP=45 */
	case OSAL_ERR_WOULD_BLOCK:
		return "OSAL_ERR_WOULD_BLOCK"; /* EWOULDBLOCK=EAGAIN=35 */
	case OSAL_ERR_INTERRUPTED:
		return "OSAL_ERR_INTERRUPTED"; /* EINTR=4 */
	case OSAL_ERR_RESOURCE_LIMIT:
		return "OSAL_ERR_RESOURCE_LIMIT"; /* EMFILE=24 */
	/* OSAL_ERR_TIMER_UNAVAILABLE 也映射到 EAGAIN=35，与 EWOULDBLOCK
     * 冲突，已移除 */
	...
	case OSAL_ERR_INVALID_INT_NUM:
		return "OSAL_ERR_INVALID_INT_NUM";
	...
	case OSAL_ERR_QUEUE_ID:
		return "OSAL_ERR_QUEUE_ID";
	case OSAL_ERR_TIMER_INVALID_ARGS:
		return "OSAL_ERR_TIMER_INVALID_ARGS";
	case OSAL_ERR_TIMER_ID:
		return "OSAL_ERR_TIMER_ID";
	case OSAL_ERR_TIMER_INTERNAL:
		return "OSAL_ERR_TIMER_INTERNAL";
