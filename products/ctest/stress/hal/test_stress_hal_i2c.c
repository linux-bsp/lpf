...
static int32_t i2c_concurrent_worker(void *user_data, uint32_t iteration)
{
    ...
    /* Write to register */
    ret = HAL_I2C_write_reg(ctx->handle,
                            I2C_STRESS_SLAVE_ADDR,
                            reg_addr,
                            write_data,
                            sizeof(write_data));
    ...
    ret = HAL_I2C_read_reg(ctx->handle,
                           I2C_STRESS_SLAVE_ADDR,
                           reg_addr,
                           read_data,
                           sizeof(read_data));
