...
const aconfig_tc_config_t g_ccm_tc_configs[] = {
    /* 服务器电源控制 → BMC */
    { ACONFIG_TC_POWER_ON,             ACONFIG_DEVICE_BMC, "payload_bmc", true, NULL },
    { ACONFIG_TC_POWER_OFF,            ACONFIG_DEVICE_BMC, "payload_bmc", true, NULL },
    { ACONFIG_TC_POWER_RESET,          ACONFIG_DEVICE_BMC, "payload_bmc", true, NULL },
    { ACONFIG_TC_POWER_CYCLE,          ACONFIG_DEVICE_BMC, "payload_bmc", true, NULL },
    { ACONFIG_TC_SOFT_RESET,           ACONFIG_DEVICE_BMC, "payload_bmc", true, NULL },
    { ACONFIG_TC_HARD_RESET,           ACONFIG_DEVICE_BMC, "payload_bmc", true, NULL },

    /* MCU控制 → MCU */
    { ACONFIG_TC_MCU_RESET,            ACONFIG_DEVICE_MCU, "power_mcu", true, NULL },
    { ACONFIG_TC_MCU_POWER_CTRL,       ACONFIG_DEVICE_MCU, "power_mcu", true, NULL },

    /* FPGA控制 → FPGA */
    { ACONFIG_TC_FPGA_RESET,           ACONFIG_DEVICE_FPGA, "main_fpga", true, NULL },
