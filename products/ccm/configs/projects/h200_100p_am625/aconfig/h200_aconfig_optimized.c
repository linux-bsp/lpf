...
static const aconfig_tc_entry_t g_h200_tc_entries[] = {
    ...
    /* 系统控制 */
    {
        .function_id = CCM_TC_SYSTEM_RESET,
        .config = {
            .function_id = CCM_TC_SYSTEM_RESET,
...
static const aconfig_tm_entry_t g_h200_tm_entries[] = {
    ...
    {
        .function_id = CCM_TM_VOLTAGE_12V,
        .config = {
            .function_id = CCM_TM_VOLTAGE_12V,
            .device = {.type = PCONFIG_DEVICE_BMC, .index = 0},
            .poll_period_ms = 2000,
    ...
    {
        .function_id = CCM_TM_VOLTAGE_3V3,
        .config = {
            .function_id = CCM_TM_VOLTAGE_3V3,
            .device = {.type = PCONFIG_DEVICE_BMC, .index = 0},
            .poll_period_ms = 2000,
    ...
    /* 系统遥测 */
    {
        .function_id = CCM_TM_SYSTEM_UPTIME,
        .config = {
            .function_id = CCM_TM_SYSTEM_UPTIME,
            .device = {.type = PCONFIG_DEVICE_MCU, .index = 0},
