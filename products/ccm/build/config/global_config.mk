...
# CONFIG_ACL_BUILD_SHARED is not set
...
# CONFIG_PCL_BUILD_SHARED is not set
...
# CONFIG_PDL_BUILD_SHARED is not set
# end of PDL Build Configuration

# CONFIG_PDL_SATELLITE_SUPPORT is not set
# CONFIG_PDL_BMC_SUPPORT is not set
# CONFIG_PDL_MCU_SUPPORT is not set
# CONFIG_PDL_WATCHDOG_SUPPORT is not set
CONFIG_H200_AM625=y
...
CONFIG_APP_COMM=y
# CONFIG_APP_HEALTH is not set
# CONFIG_APP_LOGGER is not set
# CONFIG_APP_SUPERVISOR is not set
