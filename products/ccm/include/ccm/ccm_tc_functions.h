...
typedef enum {
    ...
    CCM_TC_WATCHDOG_ENABLE = 0x12D,
    CCM_TC_WATCHDOG_DISABLE = 0x12E,
...
#define ACONFIG_TC_WATCHDOG_ENABLE         CCM_TC_WATCHDOG_ENABLE
#define ACONFIG_TC_WATCHDOG_DISABLE        CCM_TC_WATCHDOG_DISABLE
